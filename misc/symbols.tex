...
% continua
\newcommand{\thermalcont}{\omega_\text{th}}
\nomenclature{$\thermalcont$}{thermal continuum}
\newcommand{\slowcontmin}{\omega_\text{S}^-}
\nomenclature{$\slowcontmin$}{slow continuum, backwards propagating}
\newcommand{\slowcontplus}{\omega_\text{S}^+}
\nomenclature{$\slowcontplus$}{slow continuum, forwards propagating}
\newcommand{\alfvencontmin}{\omega_\text{A}^-}
\nomenclature{$\alfvencontmin$}{Alfv\'en continuum, backwards propagating}
\newcommand{\alfvencontplus}{\omega_\text{A}^+}
\nomenclature{$\alfvencontplus$}{Alfv\'en continuum, forwards propagating}
...
\newcommand{\dkappaperpdrho}{\frac{\partial \kappaperp}{\partial \rho}}
\newcommand{\dkappaperpdT}{\frac{\partial \kappaperp}{\partial T}}
\newcommand{\dkappaparadT}{\frac{\partial \kappapara}{\partial T}}
\newcommand{\dkappaperpdB}{\frac{\partial \kappaperp}{\partial (B^2)}}
...
\newcommand{\etamat}{\mathbf{R}}
\newcommand{\flowmat}{\mathbf{F}}
\newcommand{\viscmat}{\mathbf{\Sigma}}
\newcommand{\coolmat}{\mathbf{\Lambda}}
\newcommand{\condmat}{\mathbf{K}}
\newcommand{\sgravmat}{\mathbf{G}}
\newcommand{\hallmat}{\mathbf{H}}
\newcommand{\bmathall}{\mathbf{B}_\hallmat}
...
\newcommand{\alfvenspeed}{c_\text{A}} % keep capital A for consistency with figures
...
\newcommand{\tubespeed}{c_\text{t}}
\nomenclature{$\tubespeed$}{tube speed in a magnetic flux tube}
\newcommand{\kinkspeed}{c_\text{k}}
\nomenclature{$\kinkspeed$}{kink speed in a magnetic flux tube}
...
\newcommand{\gdot}{g_\odot}
\nomenclature{$\gdot$}{the solar gravitational constant}
\newcommand{\Rdot}{R_\odot}
\nomenclature{$\Rdot$}{the solar radius}
...
\newcommand{\Fplusfull}{\frac{k_2 B_{02}}{\eps} + k_3B_{03}}
\newcommand{\Gminfull}{\frac{k_2 B_{03}}{\eps} - k_3B_{02}}
\newcommand{\Vplusfull}{\frac{k_2 v_{02}}{\eps} + k_3v_{03}}
\newcommand{\hj}[1]{h_j^{#1}}
\newcommand{\hk}[1]{h_k^{#1}}
\newcommand{\dhj}[1]{\dfrac{dh_j^{#1}}{dr}}
\newcommand{\dhk}[1]{\dfrac{dh_k^{#1}}{dr}}
