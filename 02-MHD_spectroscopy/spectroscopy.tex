...
\subsection{Introduction to MHD spectroscopy}
  ...
  \resizebox{\hsize}{!}{$
    \begin{pmatrix}
      ...
      -i\gmone \dHLFrho &
        ...
        0 &
        \gmone T_0 \kpara &
        -\dfrac{i\gmone}{\rho_0}\Bigl(K + \rho_0 \dHLFT\Bigr) &
        0 &
        0 &
        0 \\
      0 & 0 & iB_0 & 0 & 0 & 0 & 0 & 0 \\
...
\begin{equation}
  \omega v_{1y} = -\frac{iB_0}{\rho_0}\kpara^2 A_{1x} + \frac{iB_0}{\rho_0}\kpara\kperp A_{1z}.
\end{equation}
If we combine this with the expressions for the $\omega A_{1x} = iB_0 v_{1y}$ and $\omega A_{1z} = 0$ components, i.e. the sixth and eight rows of the above matrix, the $v_{1y}$ component can be written as
\begin{equation}
...
\begin{equation} \label{eq: alfven_accumulation_point}
  \omega_A^2 = \lim_{\kperp \rightarrow \infty}\omega_a^2 = \kpara^2\alfvenspeed^2,
\end{equation}
meaning that the Alfv\'en modes are \emph{infinitely degenerate} since they do not depend on $\kperp$. There is hence no difference between $\omega_a^2$ and $\omega_A^2$ in this case.

For the slow modes on the other hand we find that
\begin{equation} \label{eq: slow_accumulation_point}
  \omega_S^2 =
    \lim_{\kperp \rightarrow \infty}\omega_s^2 =
    \kpara^2 \frac{\alfvenspeed^2 \soundspeed^2}{\alfvenspeed^2 + \soundspeed^2} =
    \frac{\gamma \rho_0 T_0}{\gamma \rho_0 T_0 + B_0^2}\omega_A^2,
\end{equation}
...
\begin{equation} \label{eq: fast_accumulation_point}
  \omega_F^2 = \lim_{\kperp \rightarrow \infty}\omega_f^2 = \infty.
\end{equation}
...
\begin{figure}[t]
  ...
  \caption{
    ...
    Panel \textbf{b}: zoom of panel \textbf{a}, clearly showing the degenerate and accumulating behaviour of the Alfv\'en and slow modes, respectively. The slow accumulation point $\omega_S$ is denoted with a red dotted line, the arrow indicates the direction of increasing $n$.
  }
